...
/*   Updated: 2017/09/12 18:33:19 by mmorel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						ft_printf_flag_dispatch(t_mods *mod,
							va_list insertion, int argument);
int						ft_printf_capture_flags(const char *restrict format,
							t_mods *mod, int index);
int						ft_printf_capture_precision(const char *restrict format,
							t_mods *mod, int index);
int						ft_printf_capture_width(const char *restrict format,
							t_mods *mod, int index);
...
int						ft_pf_llu_len_base
							(unsigned long long n, const int base);
...
char					*ft_pf_d_toa_dispatch
							(t_mods *mod, intmax_t nbr, int base);
char					*ft_pf_ud_toa_dispatch
							(t_mods *mod, uintmax_t nbr, int base);
...
int						ft_pf_num_precision_check
							(t_mods *mod, t_pf_string *nbr);
